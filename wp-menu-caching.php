...
define( 'WP_MENU_CACHING_BASE_FILE', 'wp-menu-caching/wp-menu-caching.php' );

/**
 * The code that runs during plugin activation.
 * This action is documented in includes/class-wp-menu-caching-activator.php
 */
function activate_dc_menu_caching() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-wp-menu-caching-activator.php';
    Wp_Menu_Caching_Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-wp-menu-caching-deactivator.php
 */
function deactivate_dc_menu_caching() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-wp-menu-caching-deactivator.php';
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-wp-menu-caching.php';
