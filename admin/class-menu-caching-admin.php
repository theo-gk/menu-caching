...
class Wp_Menu_Caching_Admin {
	...
	public function enqueue_styles( $hook ) {
		...
		if ( 'tools_page_menu-caching' === $hook ) {
			...
			wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/menu-caching-admin.css', [], $assets_version );
		}
	}
	...
	public function enqueue_scripts( $hook ) {
		...
		if ( 'tools_page_menu-caching' === $hook ) {
			...
			wp_register_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/menu-caching-admin.js', [ 'jquery' ], $assets_version, [ 'strategy' => 'defer' ] );
			wp_localize_script( $this->plugin_name, 'dc_mc_data', $ajax_data );
